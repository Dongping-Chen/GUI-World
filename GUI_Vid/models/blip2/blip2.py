...
class Blip2Base(nn.Module):
    ...
    def init_tokenizer(cls, truncation_side="right"):
        ...
        tokenizer = BertTokenizer.from_pretrained("/media/sata1/cdp/transformer/bert-base-uncased", truncation_side=truncation_side, local_files_only=True)
    ...
    def init_Qformer(
        ...
        encoder_config = BertConfig.from_pretrained("/media/sata1/cdp/transformer/bert-base-uncased", local_files_only=True)
